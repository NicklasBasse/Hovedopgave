...
export const PRODUCTS: Product[] = [
  ...
  { slug: "sah-hjemmebanestromper-25-26", img: pSocksYellow, name: "SAH hjemmebane spillertrøje 25/26 Børn", price: "105 kr.", excluded: true, brand: "adidas", hasSizes: true, category: "spillertoj" },
