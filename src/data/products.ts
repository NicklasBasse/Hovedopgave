...
export const PRODUCTS: Product[] = [
  ...
  { slug: "sah-hjemmebanestromper-25-26", img: pSocksYellow, name: "SAH udebane spillertrøje 25/26 Børn", price: "105 kr.", excluded: true, brand: "adidas", hasSizes: true, category: "spillertoj" },
