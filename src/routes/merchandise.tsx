...
const products: CategoryProduct[] = [
  ...
  { slug: "sah-udebanetroje-25-born", img: pAwayKids, name: "SAH hoodie", price: "150 kr." },
  { slug: "sah-precision-training-fodbold", img: pBallBlue, name: "SAH halstørklæde", price: "150 kr." },
  { slug: "sah-stovlepose", img: pBootbag, name: "SAH cap", price: "150 kr." },
  { slug: "sah-precision-training-fodbold-gron", img: pBallGreen, name: "SAH bøllehat", price: "150 kr." },
  { slug: "sah-fodbold-gul", img: pBallYellow, name: "SAH håndklæde", price: "150 kr." },
  { slug: "sah-130x160-fleecetaeppe", img: pBlanket, name: "SAH flag", price: "150 kr." },
];
