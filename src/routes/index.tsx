...
const focusProducts: Product[] = [
  ...
  { slug: "sah-udebanetroje-25-born", img: pAwayKids, name: "​SAH hoodie", price: "​" },
  { slug: "sah-precision-training-fodbold", img: pBallBlue, name: "SAH bøllehat", price: "175 kr.", oldPrice: "250 kr.", badge: "KLUBPRIS - SPAR 20%" },
