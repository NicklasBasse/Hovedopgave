...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Oplev SAH merchandise - Bliv en del af holdet | SPORT 24" },
      { property: "og:description", content: "Oplev den nye SAH merchandise-kollektion hos SPORT 24. Fra unikt fan-mønster til moderne streetwear. Klik her, se udvalget og find din favorit!" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Oplev SAH merchandise - Bliv en del af holdet | SPORT 24" },
